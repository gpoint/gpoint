...
### [Donner](https://github.com/) — Nigeria-First Founder-Investor Platform
A platform connecting early-stage founders with investors via SAFEs and VC application autofill. Designed to reduce the friction between African startups and capital.
...
**Frontend:** Vue 3, Next.js, Tailwind CSS, React, Vanilla  
**Backend:** Java Spring Boot, Node.js  
**Databases:** Any and Every
**Infra:** GCP, Linux (Debian-based, Arch-based)

---

## 🌍 Based in

Abuja, Nigeria — building for the continent and beyond.
